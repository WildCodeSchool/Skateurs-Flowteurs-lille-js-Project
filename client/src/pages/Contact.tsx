...
export const Contact = () => {
  return (
    <div className={styles.Contact}>
      <p>
        Ce projet web a été réalisé dans le cadre d'un travail d'équipe composé
        de quatre développeurs passionnés, dans un délai d'un mois.
        <br />
        <br />
        ...
        développement et une organisation Agile. <br />
        <br />
        Nous avons travaillé ensemble sur toutes les étapes du projet :
        conception des maquettes sur Figma, modélisation des données,
        développement des composants, intégration d'API, gestion des routes, et
        mise en place d'un design responsive.
        <br />
        <br /> Ce site est le fruit d'un véritable travail collaboratif, où
        chacun a pu apporter ses compétences et sa créativité.
      </p>
      <br />
      <br />
      <br />
